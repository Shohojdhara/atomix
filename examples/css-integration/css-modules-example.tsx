          ...
          <Card className={styles.customCard}>
            ...
            <div className="c-card__body">
              ...
              <div className={styles.formGroup}>
                <Input placeholder="Your email address" className={styles.customInput} />
                <Input placeholder="Your message" className={styles.customTextarea} />
              </div>
          ...
          <div className={styles.featureGrid}>
            ...
            <div className={`c-card ${styles.featureCard}`}>
              <div className="c-card__body">
                ...
                <p className={styles.featureText}>Optimized CSS loading and tree-shaking</p>
              </div>
            </div>
            ...
            <div className={`c-card ${styles.featureCard}`}>
              <div className="c-card__body">
                ...
                <p className={styles.featureText}>Easy to maintain and update styles</p>
              </div>
            </div>
          </div>
        </div>
