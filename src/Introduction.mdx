...
1.  **Installation:** (Assuming you use npm or yarn)
    ...
    ```bash
    npm install @shohojdhara/atomix@latest # or yarn add @shohojdhara/atomix
    ```
...
2.  **Usage:**
    ...
    import '@shohojdhara/atomix/dist/index.css'; // Assuming you have a main CSS file
...
The Atomix Theme System provides comprehensive theming capabilities. Check out the [Theme System stories](?path=/story/theme-system-overview--default) to see how to use themes in your application.
