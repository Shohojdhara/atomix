...
const ChartTooltip = memo<ChartTooltipProps>(({
  ...
  useEffect(() => {
    ...
    let newY = position.y - rect.height - 8;
  ...
  return (
    ...
    >
      {customRenderer ? (
        ...
        <>
          <div className="c-chart__tooltip-title">
            {dataPoint.label}
          </div>
          <div className="c-chart__tooltip-content">
            {datasetLabel && (
              <div className="c-chart__tooltip-dataset">
                ...
                />
                <span className="c-chart__tooltip-dataset-label">
                  {datasetLabel}:
                </span>
                <span className="c-chart__tooltip-value">
                  {dataPoint.value}
                </span>
              </div>
            )}
