...
document.addEventListener('DOMContentLoaded', () => {
  ...
  sliders.forEach(element => {
    const options = {
      ...
      direction: (element.getAttribute('data-direction') || 'horizontal') as
        | 'horizontal'
        | 'vertical',
      ...
      pagination: element.hasAttribute('data-pagination')
        ? {
            enabled: true,
            type: (element.getAttribute('data-pagination-type') || 'bullets') as
              | 'bullets'
              | 'fraction'
              | 'progressbar',
      ...
      // Effect
      effect: {
        type: (element.getAttribute('data-effect') || 'slide') as
          | 'slide'
          | 'fade'
          | 'cube'
          | 'coverflow'
