...
export default class AtomixSlider {
  ...
  constructor(
    ...
    options: Partial<typeof AtomixSlider.prototype.options> = {}
  ) {
  ...
  private renderPagination(): void {
    ...
    this.slides.forEach((_, index) => {
      ...
      bullet.innerHTML =
        '<svg width="8" height="8" viewBox="0 0 256 256"><circle cx="128" cy="128" r="128" fill="currentColor"/></svg>';
  ...
  public getSlideSize(): number {
    ...
    return (
      (containerSize - this.options.spaceBetween * (this.options.slidesToShow - 1)) /
  ...
  public emit(eventName: string, ...args: any[]): void {
    ...
    window.dispatchEvent(
      new CustomEvent(`atomix:${eventName}`, {
