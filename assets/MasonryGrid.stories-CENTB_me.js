  ...
  render: () => {
    ...
    const DynamicLoadingExample = () => {
      ...
      return <div>
          ...
          {loading && <div className="u-p-4 u-mb-4 u-bg-brand-subtle u-border u-rounded u-text-center">
